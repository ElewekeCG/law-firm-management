                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input name="paymentDate" type="date" class="form-control" placeholder=""
                                    id="customer_last_name" value="{{ old('paymentDate', $trans->paymentDate) }}">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="narration" id="customer_email" class="form-control" value="{{ old('narration', $trans->narration) }}">
